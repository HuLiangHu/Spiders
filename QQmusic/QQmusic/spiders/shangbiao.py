...
class ShangbiaoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        with open('shangbiao.txt','r',encoding='utf-8') as f:
    ...
    def parse(self, response):
        ...
        item = {}
        item['申请人'] = response.meta['ownerName']
        item['商标名称'] = i['name']
        item['代理人名称'] = i['agency']
        ...
        item['商标公告'] = ','.join(
            info['annDate'] + '-' + info['annTypeName'] + ' ' + '第' + info['annNum'] + '期' for info in i['announces'])
        item['图片'] = i['image']
        yield item
